...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder '.', '/vagrant', type: 'rsync', rsync__auto: true, rsync__exclude: '.git/', id: 'beebuzz-dev'
  ...
  config.vm.provider 'virtualbox' do |vb|
    ...
    vb.name = 'BeeBuzz Development VM'
  ...
  config.vm.provision 'file', source: 'config/provisioning/fonts.zip', destination: '~/fonts.zip'
